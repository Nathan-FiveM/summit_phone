                ...
                <div className="messageDetails">
                    <div className="headerbar">
                        ...
                        <div className="headerMainCont" style={{ marginLeft: conversationType === 'private' ? "10%" : conversationType === "group" && isAdmin ? "15%" : "0%" }}>
                            <Avatar src={avatar ?? "https://cdn.summitrp.gg/uploads/server/phone/emptyPfp.svg"} size="2.0833333333333335vw" radius="xl" onClick={() => {
                            ...
                            <TextInput value={name} disabled={conversationType === 'group' && isAdmin ? false : true} onChange={(e) => setName(e.currentTarget.value)} placeholder="Name" styles={{
                                root: { backgroundColor: "rgba(0,0,0,0)", minHeight: '0vw', height: '1.5vw', marginLeft: '0vw' },
                                input: {
                                    color: "white",
                            ...
                            {conversationType === 'private' ? <svg onClick={() => {
                                ...
                                {isAdmin ? <div style={{
                                    ...
                                    <svg onClick={async () => {
                                        ...
                                        cursor: 'pointer',
                                    }} width="1.1vw" height="1.1vw" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    }} width="1.0416666666666667vw" height="1.0416666666666667vw" viewBox="0 0 5 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            {(styles) => <div style={{
                                ...
                                <TextInput value={typedPhoneNumber} onChange={(e) => setTypedPhoneNumber(e.currentTarget.value)} placeholder="Enter Contact number" styles={{
                                    root: { backgroundColor: "", width: '95%', height: '1.5vw', marginLeft: '0.5vw' },
                                    input: {
                                        color: "white",
                                        backgroundColor: "rgba(0,0,0,0)",
