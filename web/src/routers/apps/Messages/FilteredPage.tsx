        ...
        <CSSTransition nodeRef={nodeRef} in={location.app === 'message' && location.page.messages === 'all'} timeout={450} classNames="enterandexitfromtop" unmountOnExit mountOnEnter onEntering={async () => {
            ...
            <div ref={nodeRef} style={{
                ...
                <div className="messageContent">
                    {channelsData.filter(channel => channel.name.toLowerCase().includes(searchValue.toLowerCase())).map((channel, index) => {
                                        ...
                                        <div className="title">
                                            ...
                                            <div className="timeStamp">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="8" height="12" viewBox="0 0 8 12" fill="none">
                                                    <path d="M1 11L6.35469 6.53775C6.69052 6.2579 6.69052 5.7421 6.35469 5.46225L1 1" stroke="white" stroke-opacity="0.5" stroke-width="2" stroke-linecap="round" />
                                                </svg>
                                            </div>
                                        </div>
