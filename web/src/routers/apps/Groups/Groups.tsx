                    ...
                    {(styles) => <div style={{
                        ...
                        <div style={{
                            ...
                            {groupsData && groupsData.filter(group =>
                                ...
                                const isLeader = currentGroupData.find(member =>
                                    member.playerId === playerSource && member.isLeader
                                );
                                const isMember = currentGroupData.find(member =>
                                    member.playerId === playerSource
                                );
                                ...
                                return (
                                    <div key={i} style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{ fontSize: '0.8vw', width: '10vw', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>{group.name}</div>
                                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                                <div style={{ display: 'flex', color: 'rgba(255,255,255, 0.5)', fontSize: '0.8vw', alignItems: 'center', gap: '0.2vw', lineHeight: '0.5vw' }}>
                                                    ...
                                                    <div style={{ fontSize: '0.7vw' }}>{group.memberCount}</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div style={{
