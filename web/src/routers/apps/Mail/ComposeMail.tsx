    ...
    return (
        ...
        >
            {(styles) => <div style={{
                ...
                bottom: '0',
                position: 'absolute',
                borderRadius: '0.625vw 0.625vw 2.2395833333333335vw 2.2395833333333335vw',
                background: '#262626',
                display: 'flex',
                ...
                <div className="headerOfComposeMail">
                    ...
                    }} className='clickanimation' xmlns="http://www.w3.org/2000/svg" width="1.0416666666666667vw" height="1.0416666666666667vw" viewBox="0 0 18 18" fill="none">
                ...
                <div className="composeMailContent">
                    <div className="composeMailData">
                        ...
                        <div style={{ width: '100%', height: '0.052083333333333336vw', backgroundColor: 'rgba(255,255,255,0.2)', marginTop: '0.2vw' }} />
                        <div className="toMail" style={{ marginTop: '0.2vw' }}>
                            <div className="title" style={{ width: '3vw' }}>From :</div>
                        ...
                        <div style={{ width: '100%', height: '0.052083333333333336vw', backgroundColor: 'rgba(255,255,255,0.2)', marginTop: '0.2vw' }} />
                        <div className="toMail" style={{ marginTop: '0.2vw' }}>
                            <div className="title" style={{ width: '4vw' }}>Subject :</div>
                        ...
                        {showAttachments && attachments.map((_attachment, index) => {
                            return (
                                <div key={index} className="toMail" style={{ marginTop: '0.2vw' }}>
                                    <div className="title" style={{ width: '3vw' }}>Link {index + 1} :</div>
