            ...
            {(styles) => <div style={{
                ...
                <div style={{
                    ...
                    <svg style={{
                        ...
                        <path d="M6.99989 16L1.34972 8.93729C1.1452 8.68163 1.1452 8.31837 1.34972 8.06271L6.99989 1" stroke="#0A84FF" strokeWidth="2" stroke-linecap="round" />
                                    ...
                                    <div className="mailsemiContainer">
                                        <div className="titleCont">
                                            ...
                                            <div className="dateTime">{formatedDate(message.date)} <svg xmlns="http://www.w3.org/2000/svg" width="6" height="12" viewBox="0 0 6 12" fill="none">
                                                <path d="M0.999878 11L4.65005 6.43729C4.85457 6.18163 4.85457 5.81837 4.65005 5.56271L0.999877 0.999999" stroke="#5E5E5E" strokeWidth="2" stroke-linecap="round" />
                                            </svg></div>
                                        </div>
