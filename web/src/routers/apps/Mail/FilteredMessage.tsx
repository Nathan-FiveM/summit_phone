...
export default function FilteredMessage(props: { show: boolean, messages: any, onMessageClick: (messageData: PhoneMailMessage) => void }) {
    ...
    const totalUnreadMessages = props.messages.filter((message: any) => message.read === false).length;
            ...
            {(styles) => <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <svg style={{ transition: '0.2s all ease' }} width={selectedTab === 'inbox' ? '0.5208333333333334vw' : '0.8333333333333334vw'} height={selectedTab === 'inbox' ? '0.5208333333333334vw' : '0.8333333333333334vw'} opacity={selectedTab === 'inbox' ? '1' : '0.3'} viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {selectedTab === 'inbox' ? <div style={{
                            ...
                            lineHeight: '0.5208333333333334vw',
                    ...
                    <div style={{
                        ...
                        <svg style={{ transition: '0.2s all ease', }} width={selectedTab === 'social' ? '0.8333333333333334vw' : '0.8333333333333334vw'} height={selectedTab === 'social' ? '0.6333333333333334vw' : '0.8333333333333334vw'} opacity={selectedTab === 'social' ? '1' : '0.3'} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M3.99988 14C3.44788 14 2.99988 14.448 2.99988 15C2.99988 15.552 3.44788 16 3.99988 16C4.55188 16 4.99988 15.552 4.99988 15C4.99988 14.448 4.55188 14 3.99988 14Z" fill="white" fill-opacity="1" />
                            <path d="M13.354 14C12.802 14 12.354 14.448 12.354 15C12.354 15.552 12.802 16 13.354 16C13.906 16 14.354 15.552 14.354 15C14.354 14.448 13.906 14 13.354 14Z" fill="white" fill-opacity="1" />
                            <path d="M15.9999 2.66667L2.46559 1.31858C2.39775 1.02808 2.28354 0.70775 1.97234 0.457458C1.58425 0.145375 0.957461 0 -0.00012207 0V0.666708C0.775461 0.666708 1.2985 0.771125 1.55454 0.977C1.74029 1.12637 1.78971 1.32796 1.85309 1.64321L1.85209 1.64338L3.60425 11.3783C3.70479 11.9792 3.904 12.4287 4.15804 12.7527C4.46 13.138 4.85542 13.3333 5.33321 13.3333H15.3332V12.6667H5.33321C5.13625 12.6667 4.53588 12.6718 4.26034 11.2602L4.03413 10.0035L15.3332 8L15.9999 2.66667Z" fill="white" fill-opacity="1" />
                        </svg>
                    ...
                    {props.messages && props.messages.filter(
                        ...
                        return (
                            <>
                                    ...
                                    <div className="mailsemiContainer">
                                        <div className="titleCont">
                                            ...
                                            <div className="dateTime">{formatedDate(message.date)} <svg xmlns="http://www.w3.org/2000/svg" width="6" height="12" viewBox="0 0 6 12" fill="none">
                                                <path d="M0.999878 11L4.65005 6.43729C4.85457 6.18163 4.85457 5.81837 4.65005 5.56271L0.999877 0.999999" stroke="#5E5E5E" stroke-width="2" stroke-linecap="round" />
                                            </svg></div>
                                        </div>
                                ...
                                <div className="divider" style={{ marginBottom: '0.4vw' }} key={index + '_dadsa'} />
                            </>
                        )
                    })}
                </div>
                <div style={{
                    ...
                    }} className='clickanimation' xmlns="http://www.w3.org/2000/svg" width="1.25vw" height="1.25vw" viewBox="0 0 24 24" fill="none">
