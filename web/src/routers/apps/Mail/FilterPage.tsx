...
export default function FilterPage(props: { show: boolean, inboxCount: number, draftCount: number, sentCount: number, binCount: number, onClick: (filter: string) => void }) {
    return (
        <Transition
            mounted={props.show}
            transition="slide-up"
        ...
        >
            {(styles) => <div style={{
                ...
                <div style={{
                    ...
                    fontWeight: 700,
                    lineHeight: 'normal',
                    letterSpacing: '0.0390625vw',
                }}>SMRT Cloud</div>
                <div className="innerCont" style={{ marginTop: '0.2vw', marginLeft: '0', maxHeight: '9vw', overflowY: 'auto', overflowX: 'hidden' }}>
                    <div className="inbox" style={{
                        width: '100%',
                    }}>
                        <div style={{ paddingLeft: '0.3vw', display: 'flex', width: '100%' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.1979166666666667vw" height="1.1458333333333333vw" viewBox="0 0 17 18" fill="none">
                            ...
                            <div style={{
                                width: '75%', marginLeft: '0.5vw',
                                color: '#FFF',
                                fontSize: '0.8333333333333334vw',
                                fontStyle: 'normal',
                                fontWeight: 700,
                                lineHeight: 'normal',
                                letterSpacing: '0.052083333333333336vw'
                            }}>
                                Inbox
                            </div>
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    fontWeight: 700,
                                    lineHeight: 'normal',
                                    letterSpacing: '0.041666666666666664vw',
                                }}>
                                    {props.inboxCount}
                                </div>
                        ...
                        <div className="divider" style={{ marginTop: '0.2vw', width: '87%', marginLeft: '2vw' }}></div>
                        <div style={{ paddingLeft: '0.3vw', display: 'flex', width: '100%', marginTop: '0.5vw' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.1979166666666667vw" height="1.1458333333333333vw" viewBox="0 0 12 18" fill="none">
                        ...
                        <div className="divider" style={{ marginTop: '0.2vw', width: '87%', marginLeft: '2vw' }}></div>
                        <div style={{ paddingLeft: '0.3vw', display: 'flex', width: '100%', marginTop: '0.5vw' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="1.1979166666666667vw" height="1.1458333333333333vw" viewBox="0 0 15 18" fill="none">
                        ...
                        <div className="divider" style={{ marginTop: '0.2vw', width: '87%', marginLeft: '2vw' }}></div>
                        <div style={{ paddingLeft: '0.3vw', display: 'flex', width: '100%', marginTop: '0.5vw' }}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="23" height="0.9375vw" viewBox="0 0 12 14" fill="none">
                ...
                <div className="innerCont" style={{ marginTop: '1vw', marginLeft: '0', maxHeight: '9vw', overflowY: 'auto', overflowX: 'hidden' }}>
                    <div className="inbox" style={{
                        width: '100%',
                    }}>
                        <div style={{ paddingLeft: '0.3vw', display: 'flex', width: '100%' }}>
