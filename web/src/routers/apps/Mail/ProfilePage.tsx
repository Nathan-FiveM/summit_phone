    ...
    return (
        ...
        >
            {(styles) => <div style={{
                ...
                />
                <TextInput mt={'1vw'} value={profileSettings.username} label="" placeholder="Username" onChange={(e) => setProfileSettings({ ...profileSettings, username: e.currentTarget.value })} styles={{
                    root: {
                        width: '90%',
                        marginTop: '0.5vw',
                    },
                    ...
                    onBlur={() => fetchNui("disableControls", false)}
                />
                <Button mt={'1vw'} color="blue" onClick={async () => {
