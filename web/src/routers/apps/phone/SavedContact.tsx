                    ...
                    <div className="savedContactTop">
                        <div className="topButtons">
                            <svg style={{flexShrink:0}} onClick={() => {
                                setLocation({ app: 'phone', page: { phone: 'contacts' } });
                                setSelectedContact({
                                    _id: '',
                                    personalNumber: '',
                                    contactNumber: '',
                            ...
                            <div style={{
                                ...
                                <svg style={{
                                    ...
                                    <path d="M3.63605 3.63603L16.364 16.364M19 10C19 14.9706 14.9706 19 10 19C5.02944 19 1 14.9706 1 10C1 5.02944 5.02944 1 10 1C14.9706 1 19 5.02944 19 10Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                        </div>
                        <Avatar src={selectedContact.image} w={'4.6979166666666665vw'} h={'4.6979166666666665vw'} radius="50vw" />
