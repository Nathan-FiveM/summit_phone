        ...
        >
            {(styles) => <div style={{
                ...
                <div style={{
                    ...
                    fontWeight: 500,
                    fontSize: "0.78125vw",
                    lineHeight: "0.8854166666666666vw",
                ...
                <div style={{
                    ...
                    width: '92%',
                    height: '1.40625vw',
                    padding: '0.5729166666666666vw 0px',
                ...
                <div style={{
                    display: 'flex',
                    width: '15.504166666666666vw',
                    maxHeight: '23.28125vw',
                    padding: '0.20833333333333334vw 0px',
                    flexDirection: 'column',
                        ...
                        return (
                            <div key={index} className="containerSAd" style={{
                                ...
                                <div style={{
                                    ...
                                    }} xmlns="http://www.w3.org/2000/svg" width="0.7291666666666666vw" height="0.7291666666666666vw" viewBox="0 0 9 10" fill="none">
                                    ...
                                    <svg onClick={() => {
                                        stopSound();
                                    }} width="0.7291666666666666vw" height="0.7291666666666666vw" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {ringtone.name !== 'default' && <svg xmlns="http://www.w3.org/2000/svg" width="0.7291666666666666vw" height="0.7291666666666666vw" viewBox="0 0 20 20" fill="none">
