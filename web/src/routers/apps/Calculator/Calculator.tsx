    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div style={{ fontSize: '1vw', color: '#888', marginBottom: '0.5vw' }}>
                        {inputHistory || '0'}
                    </div>
                    <div>{input || '0'}</div>
                </div>
                ...
                >
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('AC')} style={{ backgroundColor: '#5D5D5F', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        AC
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('+/-')} style={{ backgroundColor: '#5D5D5F', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        +/-
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('%')} style={{ backgroundColor: '#5D5D5F', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        %
                    ...
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('÷')} style={{ backgroundColor: '#FF9E09', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.3020833333333333vw" height="1.1979166666666667vw" viewBox="0 0 25 23" fill="none">
                    ...
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('7')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        7
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('8')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        8
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('9')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        9
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('×')} style={{ backgroundColor: '#FF9E09', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="0.9895833333333334vw" height="0.9895833333333334vw" viewBox="0 0 19 19" fill="none">
                    ...
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('4')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        4
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('5')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        5
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('6')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        6
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('-')} style={{ backgroundColor: '#FF9E09', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.3020833333333333vw" height="0.15625vw" viewBox="0 0 25 3" fill="none">
                            <path d="M1.5 1.5H23.5" stroke="white" stroke-width="3" stroke-linecap="round" />
                        </svg>
                    </div>

                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('1')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        1
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('2')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        2
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('3')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        3
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('+')} style={{ backgroundColor: '#FF9E09', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.3541666666666667vw" height="1.3020833333333333vw" viewBox="0 0 26 25" fill="none">
                            <path d="M2 12.5H24M13 1.5L13 23.5" stroke="white" stroke-width="3" stroke-linecap="round" />
                        </svg>
                    </div>

                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('back')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.1979166666666667vw" height="0.8854166666666666vw" viewBox="0 0 23 17" fill="none">
                    ...
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('0')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        0
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('.')} style={{ backgroundColor: '#2A2A2C', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        .
                    </div>
                    <div className="dialpadV2button clickanimation" onClick={() => handleButtonClick('=')} style={{ backgroundColor: '#FF9E09', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '1.2vw', fontWeight: '400' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.09375vw" height="0.6770833333333334vw" viewBox="0 0 21 13" fill="none">
                            <path d="M2 1.5H19M2 11.5H19" stroke="white" stroke-width="3" stroke-linecap="round" />
                        </svg>
                    </div>
                </div>
            </div>
