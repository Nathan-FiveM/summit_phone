...
export default function SearchUser(props: { show: boolean, profileData: TweetProfileData }) {
                    ...
                    {searchResults && searchResults.map((profile) => {
                        return (
                            <div style={{
                                ...
                                <Avatar size={'1.8vw'} src={profile.avatar.length > 0 ? profile.avatar : 'https://cdn.summitrp.gg/uploads/server/phone/emptyPfp.svg'} style={{
                                    marginLeft: '0.5vw',
                                }} />
                                <div style={{
                                    marginLeft: '0.5vw', display: 'flex',
                                    flexDirection: 'column',
                                }}>
                                    <div style={{
                                        fontSize: '0.9vw',
