            ...
            {(styles) => <div style={{
                ...
                {selectedPost._id.length > 0 && <div style={{
                    ...
                    <div style={{
                        ...
                        }} style={{ marginTop: '1.45vw', cursor: 'pointer' }} width="2.1875vw" height="0.8854166666666666vw" viewBox="0 0 42 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div style={{ marginTop: '1.5vw', fontWeight: '500', fontSize: '1vw' }}>Post</div>
                    </div>
                    <div style={{
                        width: '90%',
                        height: 'auto',
                        ...
                        <div style={{
                            ...
                            <div style={{ marginLeft: '0.2vw', marginTop: '0.3vw' }}>
                                ...
                                <div style={{ fontWeight: '400', fontSize: '0.5vw', letterSpacing: '0.05vw', lineHeight: '0.7vw' }}>{selectedPost.email}</div>
                            </div>
                        </div>
                        <div style={{
                            marginTop: '0.5vw',
                            ...
                            <div style={{ fontSize: '0.6vw', fontWeight: '500', color: 'rgb(150, 150, 150)' }}>{dayjs(new Date(selectedPost.createdAt)).format('HH:mm • DD/MM/YYYY')}</div>
                            ...
                            <div style={{
                                ...
                                <div style={{ fontSize: '0.8vw', fontWeight: '500', display: 'flex', alignItems: 'center' }}>{selectedPost.retweetCount.length} <div style={{ fontSize: '.6vw', marginTop: '0.15vw', marginLeft: '0.15vw' }}>Retweets</div></div>
                                <div style={{ fontSize: '0.8vw', fontWeight: '500', display: 'flex', alignItems: 'center' }}>{selectedPost.likeCount.length} <div style={{ fontSize: '.6vw', marginTop: '0.15vw', marginLeft: '0.15vw' }}>Likes</div></div>
                            </div>
                            <div className="divider" style={{ backgroundColor: 'rgba(255,255,255,0.3)', marginTop: '0vw' }} />
                            <div style={{
                                marginTop: '0.5vw',
                                display: 'flex',
                                alignItems: 'center',
                                ...
                                <div style={{
                                    ...
                                    <div style={{ fontSize: '0.7vw', fontWeight: 500 }}>{tweets.length > 0 && selectedPost.repliesCount.length}</div>
                                </div>
                                <div style={{
                                    display: 'flex',
                                    alignItems: 'center',
                                    ...
                                    <div style={{ fontSize: '0.7vw', fontWeight: 500 }}>{tweets.length > 0 && selectedPost.retweetCount.length}</div>
                                </div>
                                <div style={{
                                    display: 'flex',
                                    alignItems: 'center',
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{
                                                ...
                                                <div style={{ fontSize: '0.7vw', fontWeight: 500 }}>{data.retweetCount.length}</div>
                                            </div>
                                            <div style={{
                                                display: 'flex',
                                                alignItems: 'center',
