                ...
                <div style={{
                    ...
                    {notificationsData.map((notification, index: number) => {
                        return <div key={index} style={{
                            ...
                            {notification.type === 'like' ? <svg width="1.0416666666666667vw" height="0.9895833333333334vw" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
