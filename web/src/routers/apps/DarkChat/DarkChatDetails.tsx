            ...
            {(styles) => (
                <div style={{
                    ...
                    <div className="header" style={{
                        ...
                        <div style={{ fontSize: '1vw', width: '100%', textAlign: 'center' }}>{props.channelName}</div>
                        <svg style={{
                            cursor: 'pointer',
                            position: 'fixed',
                            left: '0.5vw',
                            ...
                            return (
                                <div key={i} style={{
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{ fontSize: '0.8vw', color: 'white', borderRadius: '0.5vw' }}>
                                            {data.message}
                                        </div>
                                        <div style={{ fontSize: '0.5vw', color: 'grey' }}>
