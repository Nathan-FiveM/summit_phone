        ...
        >
            ...
            >
                {!phoneSettings.darkMailIdAttached ? (
                    ...
                    <div style={{ width: '95%', marginLeft: '0.5vw', display: 'flex', justifyContent: 'space-between', alignItems: 'center', letterSpacing: '0.05vw' }}>
                        ...
                        <div style={{
                            ...
                            }} size="1.8vw" src={channelProfile?.avatar ?? "https://cdn.summitrp.gg/uploads/server/phone/emptyPfp.svg"} />
                        </div>
                    </div>
                            ...
                            return (
                                <div key={i} style={{
                                    ...
                                    <div style={{
                                        ...
                                        <svg width="1vw" height="1.1458333333333333vw" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div style={{ fontSize: '0.5vw', color: '#8C8C8C', width: '20%', textAlign: 'right' }}>
                                    ...
                                    }} style={{ marginLeft: '0.3vw' }} className='clickanimation' width="0.78125vw" height="0.78125vw" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
