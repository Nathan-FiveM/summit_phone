        ...
        >
            ...
            >
                <div style={{
                    ...
                    }} width="1.25vw" height="1.25vw" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        return (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <div style={{ fontSize: '1vw', padding: '0.5vw' }}>{post.title}</div>
                                    <div style={{
                                        fontSize: '0.7vw',
                                        fontWeight: 500,
                                        display: 'flex',
                                    ...
                                    <div style={{
                                        ...
                                        }} className='clickanimation' width="1.3020833333333333vw" height="1.3020833333333333vw" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        }} className='clickanimation' width="0.78125vw" height="0.78125vw" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
