            ...
            >
                ...
                >
                    {(styles) => <div style={{
                        ...
                        <img src={circle1} alt="circle1" style={{ position: 'absolute', bottom: '-9vw', left: '-1vw', width: '59%', height: '70%', zIndex: 0 }} />
                        <img src={circle2} alt="circle2" style={{ position: 'absolute', top: '-7.5vw', right: '-1vw', width: '59%', height: '60%', zIndex: 0 }} />
                ...
                >
                    {(styles) => <div style={{
                        ...
                        <img src={smrtVecImage} alt="smrtBankLogo" style={{ width: '60%', height: 'auto', marginTop: '0', zIndex: 1, marginBottom: '4.6875vw' }} />
                        ...
                        <div style={{
                            ...
                            fontWeight: 400,
                            fontSize: '0.625vw',
                            lineHeight: '0.7291666666666666vw',
                            textAlign: 'center',
                            color: '#666666',
                            flex: 'none',
                            alignSelf: 'stretch',
                        ...
                        <Button style={{
                            ...
                            marginTop: '4vw',
                            fontSize: '0.9vw',
                            lineHeight: '1.3541666666666667vw',
                            textAlign: 'center',
                            color: 'white',
                ...
                >
                    {(styles) => <div style={{
                        ...
                        <div style={{ marginTop: '2vw', width: '90%', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                <div className="wallet-header">Good Evening,</div>
                                <div className="wallet-subheader">{walletDetails.name}</div>
                            </div>
                            <svg width="1.4583333333333333vw" height="1.5104166666666667vw" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg width="16.354166666666668vw" height="9.166666666666666vw" viewBox="0 0 284 146" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_295_188)">
                                ...
                                <g clip-path="url(#clip1_295_188)">
                                    <path d="M258.498 25.1142C259.113 25.1142 259.612 24.6154 259.612 24C259.612 23.3847 259.113 22.8859 258.498 22.8859C257.883 22.8859 257.384 23.3847 257.384 24C257.384 24.6154 257.883 25.1142 258.498 25.1142Z" stroke="white" stroke-miterlimit="10" />
                                    <path d="M263.509 25.1142C264.124 25.1142 264.623 24.6154 264.623 24C264.623 23.3847 264.124 22.8859 263.509 22.8859C262.893 22.8859 262.395 23.3847 262.395 24C262.395 24.6154 262.893 25.1142 263.509 25.1142Z" stroke="white" stroke-miterlimit="10" />
                                    <path d="M268.52 25.1142C269.135 25.1142 269.634 24.6154 269.634 24C269.634 23.3847 269.135 22.8859 268.52 22.8859C267.904 22.8859 267.406 23.3847 267.406 24C267.406 24.6154 267.904 25.1142 268.52 25.1142Z" stroke="white" stroke-miterlimit="10" />
                                </g>
                            </g>
                            <defs>
                                <linearGradient id="paint0_linear_295_188" x1="-31.953" y1="-8.01219" x2="316.428" y2="135.387" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#CE2035" />
                        ...
                        <div style={{
                            ...
                            }} className='clickanimation' width="2.0833333333333335vw" height="3.6979166666666665vw" viewBox="0 0 40 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect x="0.500244" y="0.5" width="39" height="39" rx="9.5" fill="#565656" />
                                <rect x="0.500244" y="0.5" width="39" height="39" rx="9.5" stroke="#565656" />
                                <path d="M24.3752 15.625L15.0002 25" stroke="white" stroke-width="1.5" stroke-miterlimit="10" />
                            ...
                            <svg className='clickanimation' width="2.1875vw" height="3.6979166666666665vw" viewBox="0 0 42 71" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg width="15.15625vw" style={{ marginTop: '0.4vw' }} height="2.5vw" viewBox="0 0 271 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                    {(styles) => <div style={{
                        ...
                        <div style={{
                            ...
                            <svg style={{
                            ...
                            }} className='clickanimation' width="1.9270833333333333vw" height="0.9375vw" viewBox="0 0 37 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M30 16.5L35.6502 9.43729C35.8547 9.18163 35.8547 8.81837 35.6502 8.56271L30 1.5" stroke="#0A84FF" stroke-width="2" stroke-linecap="round" />
                            </svg>

                        </div>
                        <Searchbar value={seachValue} onChange={(e) => setSearchValue(e)} mt="0.5vw" />
                        <div style={{
                            width: '90%',
                            height: '73%',
                            marginTop: '0.6vw',
                            ...
                            {contactsData && contactsData.filter(
                                ...
                                return (
                                    <div key={i} style={{
                                        ...
                                        <Avatar src={contact.image.length > 0 ? contact.image : 'https://cdn.summitrp.gg/uploads/server/phone/emptyPfp.svg'} size="2.0vw" />
                                        <div style={{
                                            marginLeft: '0.5vw',
                                            fontSize: '0.9vw',
                                            fontWeight: 600,
                ...
                >
                    {(styles) => <div style={{
                        ...
                        <Avatar src={selectedContact.image.length > 0 ? selectedContact.image : 'https://cdn.summitrp.gg/uploads/server/phone/emptyPfp.svg'} size="4.0vw" mt="1.5vw" />
                        <div style={{ fontSize: '1.2vw', marginTop: '0.2vw', fontWeight: 500, lineHeight: '1.7vw' }}>{selectedContact.firstName} {selectedContact.lastName}</div>
                        <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.7)', marginTop: '0.2vw', fontWeight: 500, lineHeight: '0.0vw' }}>A/C No - {resaccountNumber}</div>
                        <NumberInput styles={{
                            root: {
                                width: '90%',
                                height: '2.5vw',
                        ...
                        <div style={{
                            ...
                            <svg width="1.8229166666666667vw" height="0.8333333333333334vw" viewBox="0 0 35 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div style={{
                                            ...
                                            <div style={{ gap: '0.2vw', marginLeft: '0.2vw', display: 'flex', height: '2.2vw', alignItems: 'end' }}>
                                                {historyType === 'sent' ?
                                                    <svg style={{
                                                        marginLeft: '1.8vw',
                                                    }} width="1.9791666666666667vw" height="0.78125vw" viewBox="0 0 38 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <rect width="38" height="15" rx="3" fill="#91C0FF" fill-opacity="0.28" />
