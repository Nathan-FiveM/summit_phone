    ...
    return (
        ...
        >
            ...
            >
                ...
                <Searchbar value={searchValue} onChange={setSearchValue} mt="0.2vw" />
                <div style={{
                    width: '90%',
                    fontSize: '0.7vw',
                    ...
                    {(styles) => <div style={{
                        ...
                        <div className="header" style={{
                            ...
                            <svg style={{
                                ...
                                <path d="M6.99988 16L1.34971 8.93729C1.14519 8.68163 1.14519 8.31837 1.34971 8.06271L6.99988 1" stroke="#0A84FF" stroke-width="2" stroke-linecap="round" />
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <svg width="0.9375vw" height="1.5104166666666667vw" viewBox="0 0 25 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div style={{
                                    ...
                                    <div>LOCATION</div>
                                    <div style={{ fontSize: '0.7vw', lineHeight: '0.5vw', letterSpacing: '0.06vw', color: 'rgba(255,255,255,0.5)', fontWeight: '500' }}>Set Waypoint</div>
                                </div>
                            </div>
                            <div style={{
                                width: '7.7vw',
                                ...
                                <div style={{
                                    ...
                                    <div>GIVE KEYS</div>
                                    <div style={{ fontSize: '0.7vw', lineHeight: '0.5vw', letterSpacing: '0.06vw', color: 'rgba(255,255,255,0.5)', fontWeight: '500' }}>Manage Access</div>
                                </div>
                            </div>
                            <div style={{
                                width: '7.7vw',
