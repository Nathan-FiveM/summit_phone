    ...
    return (
        ...
        >
            {(styles) => <div style={{
                ...
                <div style={{ width: '95%', display: 'flex', marginTop: '2.2vw', justifyContent: 'end' }}>
                    <svg width="1.1979166666666667vw" height="1.1979166666666667vw" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div style={{
                    ...
                    fontWeight: 700,
                    fontSize: '1.875vw',
                    lineHeight: '2.2395833333333335vw',
                    color: 'white',
                }}>
                ...
                <div style={{
                    ...
                    justifyContent: 'center',
                    alignItems: 'center',
                    marginTop: '18.052083333333334vw',
                }}>
                    <div style={{
                        display: 'grid',
                        ...
                        <div className="clickButton" style={{
                            ...
                            backdropFilter: 'blur(0.9713541467984518vw)',
                            display: 'flex',
                            justifyContent: 'center',
                            alignItems: 'center',
                            borderRadius: '50%',
                        }}>
                            <svg width="1.5104166666666667vw" height="1.25vw" viewBox="0 0 29 24" fill="none" xmlns="http://www.w3.org/2000/svg">
