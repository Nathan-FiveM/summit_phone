    ...
    return (
        <CSSTransition nodeRef={nodeRef} in={phoneSettings.isLock} timeout={450} classNames="enterandexitfromtop" unmountOnExit mountOnEnter>
            <div style={{
                ...
                <div style={{
                    fontWeight: "500",
                    fontSize: "4.166666666666667vw",
                    lineHeight: "4.947916666666667vw",
                    color: "#FFFFFF",
                ...
                <div className="bottomButton" style={{
                    ...
                    <div className="button1 clickanimation">
                        <svg xmlns="http://www.w3.org/2000/svg" width="0.3645833333333333vw" height="0.9895833333333334vw" viewBox="0 0 7 19" fill="none">
                    ...
                    <div className="button1 clickanimation">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.0416666666666667vw" height="0.9895833333333334vw" viewBox="0 0 20 15" fill="none">
