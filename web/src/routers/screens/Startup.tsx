                    ...
                    {(styles) => <div style={{
                        ...
                        >
                            <SwiperSlide style={{
                                ...
                                <Image src={hello1} w={'5.729166666666667vw'} h={'1.875vw'} />
                            </SwiperSlide>
                            <SwiperSlide style={{
                                display: 'flex',
                                justifyContent: 'center',
                                ...
                                <Image src={hello2} w={'5.729166666666667vw'} h={'1.7729166666666667vw'} />
                            </SwiperSlide>
                            <SwiperSlide style={{
                                display: 'flex',
                                justifyContent: 'center',
                                ...
                                <Image src={hello3} w={'5.729166666666667vw'} h={'1.7729166666666667vw'} />
                            </SwiperSlide>
                            <SwiperSlide style={{
                                display: 'flex',
                                justifyContent: 'center',
                                ...
                                <Image src={hello4} w={'5.729166666666667vw'} h={'2.1354166666666665vw'} />
                            </SwiperSlide>
                            <SwiperSlide style={{
                                display: 'flex',
                                justifyContent: 'center',
                                ...
                                <Image src={hello5} w={'7.1875vw'} h={'1.7729166666666667vw'} />
                            </SwiperSlide>
                            <SwiperSlide style={{
                                display: 'flex',
                                justifyContent: 'center',
                                ...
                                <Image src={hello6} w={'6.773958333333334vw'} h={'1.7729166666666667vw'} />
                            </SwiperSlide>
                            <SwiperSlide style={{
                                display: 'flex',
                                justifyContent: 'center',
                                ...
                                <Image src={hello7} w={'5.729166666666667vw'} h={'1.7729166666666667vw'} />
                            </SwiperSlide>
                            <SwiperSlide style={{
                                display: 'flex',
                                justifyContent: 'center',
                                ...
                                <Image src={hello8} w={'5.729166666666667vw'} h={'2.814583333333333vw'} />
                            </SwiperSlide>
                            <SwiperSlide style={{
                                display: 'flex',
                                justifyContent: 'center',
                                ...
                                <Image src={hello9} w={'5.729166666666667vw'} h={'1.7729166666666667vw'} />
                            </SwiperSlide>
                        </Swiper>
                    </div>}
                </Transition>
                    ...
                    {(styles) => <div style={{
                        ...
                        >
                            {(styles) => <div style={{
                                ...
                                <svg width="2.9166666666666665vw" height="2.9166666666666665vw" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="usabox">
                                    <div style={{
                                        ...
                                        }} className="clickButton" style={{ cursor: 'pointer' }} xmlns="http://www.w3.org/2000/svg" width="0.3645833333333333vw" height="0.625vw" viewBox="0 0 7 12" fill="none">
